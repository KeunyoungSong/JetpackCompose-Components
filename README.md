- 인트로
    ...
    Text, Button, Surface, Box, Row, Column BoxWithConstraints, Image, AsyncImage(with Coil), Card, Checkbox, Textfield, TopAppBar, Slot API, Scaffold, LazyColumn, modifier
    
    컴포저블 함수는 컴포즈에서 UI 를 그리는 단위
    
    MainActivity 내 setContent 내에 선언된 내용은 앱의 변경 사항이고 preview 를 사용하고 싶다면 preview 애너테이션이 지정되어 있는 컴포저블 함수에 작성한다
